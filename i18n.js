const translations = {
  ...
  ar: {
    ...
    heroEyebrow: "أطلس الحوسبة",
    heroTitle1: "استكشف",
    heroTitle2: "الكون",
    heroTitle3: "الرقمي",
    heroLede: "رحلة تحريرية في تاريخ وعلوم وأخلاقيات الحوسبة — مطبوعة صفحة بصفحة، للعقل الفضولي.",
    dossier1: "رحلات سردية",
    dossier2: "ثنائي اللغة · AR / EN",
    dossier3: "مصمم للفصل الدراسي",
    dossier4: "احفظ تقدمك",
    tocLabel: "فهرس المحتويات",
    tocTitle: "الرحلات",
    tocCount: "٠٢ رحلات",
    footerLeft: "أطلس الأصل",
    footerCenter: "للعقول الفضولية",
    ...
    abacusBtnStart: "يالا نبدأ الرحلة",
    heroMeta1: "⏱ ~١٥ دقيقة",
    heroMeta2: "🗺 ١١ محطة",
    heroMeta3: "🧩 تحدي أخير",
    challengeDesc: "دوس على كارتين عشان تبدلهم لحد ما ترتب الاختراعات كلها صح — من الأقدم للأحدث.",
    guessEyebrow: "خمّن الفصل القادم",
    ...
    // Lecture 1 (Unit 1: Information & Ethics)
    lect1Edition: "الوحدة ٠١ · أولى ثانوي",
    ...
    lect1StartBtn: "ابدأ الاستكشاف التفاعلي",
    ...
    // Quizzes landing
    qzEdition: "القسم ٠٢ · قاعة الاختبارات",
    qzEyebrow: "الاختبارات والأسئلة",
    qzTitle1: "اختبر",
    qzTitle2: "نفسك",
    qzTitle3: "الآن",
    qzLede: "أسئلة اختيار من متعدد من كل محاضرة في الأطلس. اختار فصل، أجب عن الأسئلة، وشوف درجتك.",
    qzNote1: "بطاقة لكل محاضرة",
    qzNote2: "اختار فصل، أو كل الفصول",
    qzNote3: "تقييم فوري",
    qzNote4: "درجتك محفوظة",
    ...
    qzPickerTitle: "كيف تبي تختبر نفسك؟",
    qzPickerSub: "أسئلة كل الفصول مخلوطة، أو ركّز على فصل واحد.",
    qzModeAllLabel: "كل الفصول",
    qzModeAllHint: "مخلوطة · الحزمة الكاملة",
    qzStagesHeading: "أو اختار فصل",
    qzNoQuestions: "لا توجد أسئلة متاحة لهذه المحاضرة بعد.",
    qzNoLecture: "٤٠٤",
    qzNoLectureTitle: "لم يتم تحديد محاضرة",
    qzNoLectureHint: "افتح هذه الصفحة من قائمة الاختبارات لاختيار المحاضرة أولاً.",
    qzUnknownLecture: "محاضرة غير معروفة",
    qzUnknownLectureHint: "لم نتمكن من العثور على اختبار لهذا المعرف.",
    qzSkip: "تخطى",
    qzNext: "السؤال التالي",
    qzResultEyebrow: "اكتمل",
    qzResultTitle: "النتيجة",
    qzStatCorrect: "صحيحة",
    qzStatWrong: "خاطئة",
    qzStatSkipped: "متجاوزة",
    qzRetry: "حاول مرة أخرى",
    qzOtherLectures: "محاضرات أخرى",
